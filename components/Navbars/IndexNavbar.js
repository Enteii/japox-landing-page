...
export default function Navbar(props) {
  ...
  return (
    <>
      <nav className="top-0 fixed z-50 w-full flex flex-wrap items-center justify-between px-2 py-3 navbar-expand-lg bg-gray-900 bg-opacity-90 backdrop-blur border-b border-red-800 shadow-lg">
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          ...
          <div
            className={
              "lg:flex flex-grow items-center bg-gray-900 bg-opacity-90 backdrop-blur lg:bg-opacity-0 lg:shadow-none" +
