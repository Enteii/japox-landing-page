...
export default function Index() {
  return (
    <>
      ...
      <section className="mt-48 md:mt-40 pb-40 relative bg-gray-900">
        <div
                ...
                <div className="w-full md:w-6/12 px-4">
                  <div className="relative flex flex-col mt-4">
                    <div className="px-4 py-5 flex-auto">
                      <div className="text-gray-400 p-3 text-center inline-flex items-center justify-center w-12 h-12 mb-5 shadow-lg rounded-full bg-white">
                        <i className="fab fa-tiktok"></i>
                      </div>
                      <h6 className="text-xl mb-1 font-semibold">TikTok</h6>
                      <p className="mb-4 text-gray-400">
                        Follow our TikTok for vehicle showcases and promotions.
                      </p>
                    </div>
                  </div>
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <h6 className="text-xl mb-1 font-semibold">Instagram</h6>
                      <p className="mb-4 text-gray-400">
                        See behind-the-scenes photos and updates on Instagram.
                      </p>
                    </div>
                  </div>
                </div>
                <div className="w-full md:w-6/12 px-4">
                  <div className="relative flex flex-col min-w-0 mt-4">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <h6 className="text-xl mb-1 font-semibold">YouTube</h6>
                      <p className="mb-4 text-gray-400">
                        Watch in-depth vehicle reviews on our YouTube channel.
                      </p>
                    </div>
                  </div>
                  <div className="relative flex flex-col min-w-0">
                    <div className="px-4 py-5 flex-auto">
                      ...
                      <h6 className="text-xl mb-1 font-semibold">X</h6>
                      <p className="mb-4 text-gray-400">
                        Follow our latest news and updates on X (Twitter).
                      </p>
                    </div>
                  </div>
                </div>
        ...
        <div className="container mx-auto overflow-hidden pb-20">
          <div className="flex flex-wrap items-center">
            <div className="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
              <div className="text-gray-400 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white">
              ...
              <div className="block pb-6">
                <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-gray-400 bg-white uppercase last:mr-0 mr-2 mt-2">
                  TikTok
                </span>
                <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-gray-400 bg-white uppercase last:mr-0 mr-2 mt-2">
                  Instagram
              ...
              <a
                ...
                target="_blank"
                className="font-bold text-gray-700 hover:text-gray-400 ease-linear transition-all duration-150"
              >
                View All{" "}
                ...
                <ul className="list-none mt-6">
                  <li className="py-2">
                    <div className="flex items-center">
                      <div>
                        <span className="text-xs font-semibold inline-block py-1 px-2 uppercase rounded-full text-gray-400 bg-blueGray-50 mr-3">
        ...
        <div className="justify-center text-center flex flex-wrap mt-24">
          <div className="w-full md:w-6/12 px-12 md:px-4">
            <h2 className="font-semibold text-4xl">Explore JAPOX</h2>
            <p className="text-lg leading-relaxed mt-4 mb-4 text-gray-400">
              Discover how JAPOX is revolutionizing Japanese used car exports
              through technology and unmatched quality.
            </p>
          </div>
        </div>
      </section>
