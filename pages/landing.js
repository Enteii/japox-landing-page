          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                <div className="text-gray-300 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white">
            ...
            <div className="items-center flex flex-wrap">
              ...
              <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
                <div className="md:pr-12">
                  <div className="text-gray-300 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-gray-200">
                ...
                <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-gray-200">
                  <div className="flex-auto p-5 lg:p-10">
                    ...
                    <div className="relative w-full mb-3 mt-8">
                      ...
                      <input
                        type="text"
                        className="border-0 px-3 py-3 placeholder-gray-300 text-gray-300 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full ease-linear transition-all duration-150"
                    ...
                    <div className="relative w-full mb-3">
                      ...
                      <textarea
                        rows="4"
                        cols="80"
                        className="border-0 px-3 py-3 placeholder-gray-300 text-gray-300 bg-white rounded text-sm shadow focus:outline-none focus:ring w-full"
